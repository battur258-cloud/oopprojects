...
public class Polygon {
    ...
    {
        double z = Math.toRadians(angle);// concert to radians
        for(int i = 0; i < nextIndex; i++){
            ...
            y = y-b;
            //Rotate
            double x2 = x * cos(z) - y * sin(z);
            double y2 = x * sin(z) - y * cos(z);
            //Translate back
            x2 = x2 + a;
            y2 = y2 + b;
    ...
    public String toString() { return "Polygon: " + Arrays.toString(xpoints) + " " + Arrays.toString(ypoints);
    }
}
