...
public class Tests {
    ...
    public static void testPolygons() {
        ...
        rectangle2.addPoint(50,50);
        rectangle2.addPoint(110,50);
        rectangle2.addPoint(110,150);
        rectangle2.addPoint(50, 150);
    ...
    public static void testTranslation() {
        ...
        Polygon rectangle2 = new Polygon(4, Color.RED);
        rectangle2.addPoint(50,50);
        rectangle2.addPoint(110,50);
        rectangle2.addPoint(110,150);
        rectangle2.addPoint(50, 150);
    ...
    public static void testRotation() {
        ...
        triangle.addPoint(250, 100); // top
        triangle.addPoint(400, 400); // bottom-right
        triangle.addPoint(100, 400); // bottom-left

        // Step 2: Create a canvas
        SimpleCanvas canvas = new SimpleCanvas(500, 500);
        canvas.show();

        // Step 3: Draw the original triangle
        triangle.drawOn(canvas);
        canvas.update();

        // Step 4: Pause so we can see the original triangle
        canvas.waitForClick(); // waits for user to click

        // Step 5: Rotate around the center of the triangle (roughly (250, 300))
        triangle.rotateAround(250, 300, 90); // rotate 90 degrees clockwise
        canvas.clear(); // clear the canvas if you want to only see the rotated version
        triangle.drawOn(canvas);
        canvas.update();
        canvas.waitForClick(); // wait to see the rotated triangle

        // Step 6: Rotate again - 45 degrees this time
        triangle.rotateAround(250, 300, 45);
        canvas.clear();
        triangle.drawOn(canvas);
        canvas.update();
        canvas.waitForClick();
